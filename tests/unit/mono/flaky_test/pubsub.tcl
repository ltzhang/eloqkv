start_server {tags {"pubsub network"}} {
    ...
    # pub/sub commands are implemented in RESP3
    foreach resp {3} {
...
# 'CLIENT REPLY OFF' unsupported
    ...
    } {abc 0 def 0} {needs:support_cmd_later}
...
# Q? Unsupported command in MULTI, issue tracked
...
# Q? Unsupported command in lua script, issue tracked
