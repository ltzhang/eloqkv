...
# Disable these two tests because they aim to validate the integrity and correctness of the ziplist implementation, and it is slow.
    # tags {slow} {
