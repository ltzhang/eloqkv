start_server {tags {"bitfield"}} {
    ...
    test {BITFIELD_RO: get return right value} {
        r del bits
        assert_equal 0 [r bitfield bits set u8 0 255]
        assert_equal 255 [r bitfield bits set u8 0 100]
        assert_equal 100 [r bitfield_ro bits get u8 0]
    }
}
