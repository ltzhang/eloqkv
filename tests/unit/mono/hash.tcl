start_server {tags {"hash"}} {
    ...
    # this test ensures that Redis's internal optimizations for hashes do not affect the correctness of the HRANDFIELD command.
    ...
    # currently eloqkv supports RESP2 version of result for `withvalues`
    ...
    # disable slow test for 512 fields
    foreach size {10} {
    ...
    test {Hash ziplist of various encodings} {
        ...
        set _ $k
    } {ZIP_INT_8B 127 ZIP_INT_16B 32767 ZIP_INT_32B 2147483647 ZIP_INT_64B 9223372036854775808 ZIP_INT_IMM_MIN 0 ZIP_INT_IMM_MAX 12} {needs:redis_config}
