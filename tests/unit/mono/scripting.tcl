...
start_server {tags {"scripting"}} {
    ...
    test {EVAL - Lua table with ok -> Redis protocol type conversion} {
        run_script {return {1,2,3,{ok='fine'},{1,2}}} 0
    } {1 2 3 fine {1 2}}
...
# block command not supported in lua script
    ...
    test {EVAL_RO - Cannot run write commands} {
        ...
        set e
    } {ERR Write commands are not allowed from read-only scripts*} {needs:support_cmd_later}
    ...
    test {CLUSTER RESET can not be invoke from within a script} {
        ...
        set _ $e
    } {*command is not allowed*} {needs:support_cmd_later}

    # disaable it aims to test resp3
...
# TODO(ZX) implement lua unpack
    ...
    #             a[i] = 1
    #         end
    #         return redis.call("lpush", "l", table.unpack(a))
    #     } 1 l
    # } {7999}
...
# Q? match the error message
    ...
    test "allow-oom shebang flag" {
        ...
        r config set maxmemory 0
    } {OK} {needs:config-maxmemory needs:support_cmd_later} 
...
# Q? match the error message
    ...
    } {OK} {external:skip needs:repl needs:redis_config}
...
start_server {tags {"scripting"}} {
    test "Consistent eval error reporting" {
        ...
        assert_match {calls=1*rejected_calls=0,failed_calls=1*} [cmdrstat eval r]
    } {} {cluster:skip needs:redis_config}
    ...
    test {EVAL - Handle double reply} {
        run_script {redis.call('del', 'key1'); redis.call('set', 'key1', 100.5); return redis.call('get', 'key1')} 0
    } {100.5}

    test {EVAL - Handle verbatim reply} {
        run_script {redis.call('del', 'key2'); redis.call('set', 'key2', 'verbatim'); return redis.call('get', 'key2')} 0
    } {verbatim}

    test {EVAL - Handle hash reply} {
        sort_by_key [run_script {redis.call('del', 'mymap'); redis.call('hset', 'mymap', 'field1', 'value1'); redis.call('hset', 'mymap', 'field2', 'value2'); return redis.call('hgetall', 'mymap')} 0]
    } {field1 value1 field2 value2}

    test {EVAL - Handle set reply} {
        lsort [run_script {redis.call('del', 'myset'); redis.call('sadd', 'myset', 'member1'); redis.call('sadd', 'myset', 'member2'); return redis.call('smembers', 'myset')} 0]
    } {member1 member2}

    test {EVAL - Handle list reply} {
        run_script {redis.call('del', 'mylist'); redis.call('rpush', 'mylist', 'item1'); redis.call('rpush', 'mylist', 'item2'); return redis.call('lrange', 'mylist', 0, -1)} 0
    } {item1 item2}
}
